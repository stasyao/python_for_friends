...
11. После установки вам предложат запустить VS Code. Нажимите "Завершить" и следом откроется окно редактора VS Code
...
16. Нажмите сочетание клавиш **Ctrl + J** (+ нажимать не надо, имеется в виду Ctrl и J одновременно). Снизу окна появится новая панель со вкладкой **Terminal**.
...
Дождитесь исчезнования этой кнопки. Это означает, что расширение установлено.
...
В открытом окне редактора может появится вот такой вопрос.

![image](https://user-images.githubusercontent.com/60841011/222821448-d36dbcbe-7079-42c5-a540-d05b8451eebd.png)

Поставьте галочку "Trust the authors of all files…", чтобы это предупреждение больше вас не донимало.
...
- в панели Explorer вы увидете созданный файл
...
Теперь панель с терминалом будет справа. Обратите внимание вы можете расширять ее, нажимая левой кнопкой мыши на границу панели, и удерживая кнопку двигать мышь влево. На картинке граница выделена синией линией.
...
`3.11.12 64-bit` &mdash; означает, что редактор кода нашел интерпретатор для исполнения Python-файла, версия интерпрертатора 3.11.2.
...
9. А теперь давайте сделаем тоже самое, но только без помощи редактора кода (кнопки "треугольник"), 
