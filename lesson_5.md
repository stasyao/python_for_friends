...
По сути преобразование типов данных &mdash; не что иное, как создание из объект одного класса объекта другого класса.
...
`<username>, вам предстоит назвать мне подряд 2 числа, а я тебе мгновенно скажу их сумму.`
